                ...
                <div className={styles.carouwrap}>
                    <div className={styles.bannerOneRight}>
                        ...
                        <div className={styles.iconsButton2}>
                            ...
                            <div className='text-container text-width-215'>
                                <p className='text-white rotate-90-deg font-17'>MORNING OWADA</p>
                            </div>
                        </div>
                    </div>
                    <div className={styles.motoContainer}>
                        ...
                        <Carousel.Caption className='caroucap width-50-per banner-text-left'>
                            <div className={styles.bannerTextOne}>Sasanassa Pariyatti Mullam</div>
                            <div className={styles.bannerTextTwo}>A Bhikkhu Training Center established with the objective of producing bhikkhu with high qualities.</div>
